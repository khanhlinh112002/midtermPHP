...
<?php
    ...
    if (isset($_GET["id"]))
    {
        ...
        if ($id == 0)
        {
            ...
            {
                echo "<script type=\"text/javascript\">alert(\"code chạy hicc\");</script>";
            ...
            if (isset($_POST["send"]))
            {
                echo "<script type=\"text/javascript\">alert(\"code chạy\");</script>";
                ...
                VALUES ('$name', 'hi', 'hmm', '$email', $phone, '$address', 1)";
                $resCus = mysqli_query($conn,$sql);
                // Chèn vào bảng users:
                echo "<script type=\"text/javascript\">alert(\"code chạy ơ đây\");</script>";
            ...
            echo "<script type=\"text/javascript\">alert(\"code chạy nè\");</script>";
            ...
            $mail->AddReplyTo('linh.nguyenthikhanh02@gmail.com', 'Khánh Linh'); //khi nguoi dung phan hoi se duoc gui den email nay
            $mail->Subject    = $title;// tieu de email 
            $mail->Body=$body;// noi dung chinh cua mail se nam o day.
...
?>
            <script type="text/javascript">
                window.location = '../16_Thong tin muahang/orderSuccess.php?idOrderDetail=<?php echo $idOrder; ?>';
            </script>
<?php
        }
