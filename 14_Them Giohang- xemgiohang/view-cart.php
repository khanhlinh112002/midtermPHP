                    ...
                    <div class="viewcart">
                                            ...
                                            else
                                            {
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <!-- Xóa sản phẩm -->
                                                        <td><a onclick="return confirm('Bạn có chắc chắn muốn xóa sản phẩm này không?')" href ="../15_Xoa giohang/delete-cart.php?id=<?php echo $id; ?>">
                        ...
                        <div class ="col-md-7 col-sm-6 col-xs-12 title_right">
                            ...
                            <?php
                                ...
                                {
                            ?>
                                    <button><a href="../15_Xoa giohang/delete-cart.php?id=0"> Đặt hàng </a></button>
                            <?php
                                }
                                else
                                {
                            ?>
                                    <button><a href="../16_Thong tin muahang/order-cart.php"> Tiến hành mua hàng </a></button>
                            <?php
                                }
                            ?>
                        </div><!-- /col -->
