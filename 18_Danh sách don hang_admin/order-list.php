                            ...
                            if ($result)
                            {
                                ...
                                {   
                                    ...
                                    <tr class="odd gradeX" align="center">
                                        ...
                                        <td class="center">
                                            <a href="./order-detail.php?idOrderDetail=<?php echo $row['idOrder']; ?>" title="Chỉnh sửa"><i class="fa fa-info" aria-hidden="true"></i></a>
                                        </td>
                                        <td>
                                            <a onclick="return confirm('Bạn có chắc chắn muốn xóa order này không?')" href="order-delete.php?deleteAllIdOrderSame=<?php echo $row['idOrder']; ?>&statusOrder=<?php echo $row['status']; ?>" title="Xóa"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                        <?php
                                }
