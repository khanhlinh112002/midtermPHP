            ...
            <div class ="col-md-5 col-sm-6 col-xs-12">
                <div class="info-customer">
                    ...
                    <p style="text-align: center;">
                        <a href="../22_Quan ly user_Login-out/register.php"> Đăng kí mua hàng</a>&nbsp;|&nbsp;
                        <a href="../22_Quan ly user_Login-out/login.php"> Đăng nhập </a>
                    </p>
                    <!-- form mua hàng -->
            ...
            <div class ="col-md-5 col-sm-6 col-xs-12">
                ...
                $resCus = mysqli_query($conn,$sql);
                    ?>
                            ...
                            <form name="form2" action="../15_Xoa giohang/delete-cart.php?id=0" method="POST">
                                <table class="table">
                                    <tr>
                                ...
                                <center><button type="submit" class="btn" name="send"> Gửi </button></center>
                            </form>
                    <?php
                        }
                    ?>
